...
//this contains unimplimented stuff that we dont actually need
//the java spec is creaxy man, idk wtf they were thinking but we can skip major features


//hey its 2:43am chloe
//i made spring rolls!
//sleep for weak
